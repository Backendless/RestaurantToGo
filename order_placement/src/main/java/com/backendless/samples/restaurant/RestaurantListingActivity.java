...
public class RestaurantListingActivity extends ListActivity
{
  ...
  {
    Intent showLocationsIntent = new Intent( this, LocationListingActivity.class );
    Restaurant restaurant = totalRestaurants.get( position );
    restaurant.setOwner( null );
    showLocationsIntent.putExtra( "restaurant", restaurant );
